  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: MediaQuery.removePadding(
        context: context,
        removeTop: true,
        removeBottom: true, //para ios, o para los teléfonos que tengan el espacio abajo reservado
        child: _ListView(scrollController: scrollController, imagesIds: imagesIds,onRefresh: onRefresh,),
      ),
